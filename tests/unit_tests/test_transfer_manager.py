...
class TestTransferManager(test_utils.BaseTestCase):
    ...
    test_s3_files = {
        'f21d28a7-d3a5-42bf-8771-5d205ab67dcb/video/61ca75b6-2c2e-4d32-a8a6-300bf7fd6fa1.mp4': {
            ...
            'target_basename': 'REDACTED_on_demand_35224bd5-f8a8-41f6-8502-f96e12d6ddde_10',
        }
    }
    ...
    def test_get_target_basename(self):
        target_basename = self.transfer_manager.get_target_basename(f'unit-test-data/{list(self.test_s3_files.keys())[0]}')
        self.assertEqual(
            self.test_s3_files['f21d28a7-d3a5-42bf-8771-5d205ab67dcb/video/61ca75b6-2c2e-4d32-a8a6-300bf7fd6fa1.mp4']['target_basename'],
            target_basename
        )
